...
test("parity check: phase 1 refuses every address outside turva.dev's published pages", async () => {
  const cases = [
    ...
    [{ url: "https://turva.dev/markdown-parity-check" }, 403, /one of turva\.dev's two tool pages/],
    ...
    [{ url: "https://turva.dev/tools", markdownUrl: "https://turva.dev/markdown-parity-check.md" }, 403, /one of turva\.dev's two tool pages/],
    [{ url: "https://turva.dev/llms-txt-validator?url=example.com" }, 403, /one of turva\.dev's two tool pages/],
    [{ url: "https://turva.dev/LLMS-TXT-VALIDATOR/" }, 403, /one of turva\.dev's two tool pages/],
    [{ url: "https://turva.dev/tools", markdownUrl: "https://turva.dev/llms-txt-validator.html.md" }, 403, /one of turva\.dev's two tool pages/],
    [{ url: "https://turva.dev/tools", markdownUrl: "https://turva.dev/Markdown-Parity-Check.HTML.MD" }, 403, /one of turva\.dev's two tool pages/],
    [{ url: "https://turva.dev/markdown-parity-check.js" }, 403, /not one of turva\.dev's published pages/],
