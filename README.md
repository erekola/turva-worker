...
Measured on `https://turva.dev` on 2026-08-01: 100/100, Level 5 (Agent-Native) on isitagentready.com, Cloudflare's agent-readiness scanner.
...
Full inventory of all 36 routes: [docs/endpoints.md](docs/endpoints.md).
